 ...
 */
router.get("/marketing/status", getMarketingUsersStatus);
 ...
 */
router.get("/marketing/my-performance", getMyMarketingPerformance);
 ...
 */
router.get("/marketing/:userId/report", getMarketingUserDetailedReport);
